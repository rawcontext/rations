...
struct AddAccountSheet: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text("This design preview adds a sample account. It does not read or change your sign-ins.")
                .font(.callout)
            HStack {
                Spacer()
    ...
    private func add() {
        ...
        let profile = AccountProfile(
            id: UUID().uuidString, provider: provider, name: name.trimmingCharacters(in: .whitespacesAndNewlines),
